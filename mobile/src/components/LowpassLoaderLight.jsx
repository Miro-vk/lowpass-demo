...
// Compact spinning arc used inside buttons
 ...
 */
export default function LowpassLoaderLight({
  size = 200,
  showLabel = true,
  ...
  // All positions in screen px, scaled from 0–1024 SVG units
  const S = size / 1024;
  const mouthL  = 246 * S;
  const mouthR  = 842 * S;
  const mouthY  = 516 * S;
